...
public class DesignCtxGame5{
	public static void load(Context p_ctxUnder){
		...
		/*DATA:0|Background|Back_Table05|/res/Back/BackGame05.png|0|50|10|1|*/
		Background backBack_Table05= new Background("/res/Back/BackGame05.png");
		backBack_Table05.setTextID("Back_Table05");
		backBack_Table05.setPos(0, 50, 10);
		backBack_Table05.load();
		p_ctxUnder.addChild(backBack_Table05, false, false);
		...
		/*DATA:1|com.bianisoft.games.pool.SprHole|Spr_Hole3|/res/Sprite/Holes.png|60|220|9|1|1|2|3|Quarters|4|0.0|Halfs|4|0.0|Full|1|0.0|*/
		...
		sprSpr_Hole3.load();
		sprSpr_Hole3.setCurState(1);
		sprSpr_Hole3.setCurFrame(2);
		p_ctxUnder.addChild(sprSpr_Hole3, false, false);

		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:2|com.bianisoft.games.pool.SprHole|Spr_Hole4|/res/Sprite/Holes.png|0|220|9|1|1|2|3|Quarters|4|0.0|Halfs|4|0.0|Full|1|0.0|*/
		...
		sprSpr_Hole4.load();
		sprSpr_Hole4.setCurState(1);
		sprSpr_Hole4.setCurFrame(2);
		p_ctxUnder.addChild(sprSpr_Hole4, false, false);

		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:3|com.bianisoft.games.pool.SprHole|Spr_Hole1|/res/Sprite/Holes.png|-39|-120|9|1|1|0|3|Quarters|4|0.0|Halfs|4|0.0|Full|1|0.0|*/
		...
		sprSpr_Hole1.load();
		sprSpr_Hole1.setCurState(1);
		sprSpr_Hole1.setCurFrame(0);
		p_ctxUnder.addChild(sprSpr_Hole1, false, false);

		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:4|com.bianisoft.games.pool.SprHole|Spr_Hole2|/res/Sprite/Holes.png|40|-120|9|1|1|0|3|Quarters|4|0.0|Halfs|4|0.0|Full|1|0.0|*/
		...
		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:5|com.bianisoft.games.pool.SprHole|Spr_Hole5|/res/Sprite/Holes.png|-60|220|9|1|1|2|3|Quarters|4|0.0|Halfs|4|0.0|Full|1|0.0|*/
		...
		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:6|com.bianisoft.games.pool.SprBall|Spr_Ball2|/res/Sprite/Ball.png|-58|163|8|1|0|1|2|BallsOthers|7|0.0|BallWhite|1|0.0|*/
		...
		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:7|com.bianisoft.games.pool.SprBall|Spr_Ball3|/res/Sprite/Ball.png|62|163|8|1|0|2|2|BallsOthers|7|0.0|BallWhite|1|0.0|*/
		...
		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:8|com.bianisoft.games.pool.SprBall|Spr_Ball4|/res/Sprite/Ball.png|-39|-58|8|1|0|3|2|BallsOthers|7|0.0|BallWhite|1|0.0|*/
		...
		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:9|com.bianisoft.games.pool.SprBall|Spr_Ball5|/res/Sprite/Ball.png|42|-58|8|1|0|4|2|BallsOthers|7|0.0|BallWhite|1|0.0|*/
		...
		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:10|com.bianisoft.games.pool.SprBall|Spr_Ball6|/res/Sprite/Ball.png|2|-17|8|1|0|5|2|BallsOthers|7|0.0|BallWhite|1|0.0|*/
		...
		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:11|com.bianisoft.games.pool.SprBall|Spr_BallWhite|/res/Sprite/Ball.png|2|22|8|1|1|0|2|BallsOthers|7|0.0|BallWhite|1|0.0|*/
		...
		sprSpr_BallWhite.setPos(2, 22, 8);
		...
		/*DATA_CUSTOM_SPRITE_TEMPLATE:#|CLASS_ID|NAME|RESSOURCE_NAME|POS_X|POS_Y|POS_Z|DEEPNESS|DEFAULT_STATE|DEFAULT_FRAME|NB_STATES|STATE_NAME|STATE_NB_FRAMES|STATE_SPEED*/
		/*DATA:12|com.bianisoft.games.pool.SprBall|Spr_Ball1|/res/Sprite/Ball.png|2|163|8|1|0|0|2|BallsOthers|7|0.0|BallWhite|1|0.0|*/
